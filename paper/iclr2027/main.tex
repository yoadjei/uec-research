...
holds. The allocation is further constrained by collinearity, under which no ranking can be
simultaneously faithful, stable and complete \citep{attribimposs2026}; our redundant-feature block
is where that tension bites. No class is protected in its \emph{allocation} across features, which is the part a
